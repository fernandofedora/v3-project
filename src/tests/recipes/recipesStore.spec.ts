...
users.forEach(user =>{
    ...
    test(`Verify the creation of a new recipe with image media type resource at store level for a single language '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        ...
        if(user.role == rolesData.superAdmin || user.role == rolesData.admin) { await topBarModel.selectNodeBrandChild(brandsData.storeBrandContentName, brandsData.store); }
        await commonModel.waitUntilSpinnerDisappears();
    ...
    test(`Verify the creation of a new recipe with all the fields at store level with a single language '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify the creation of a new recipe with a valid expire date at store level with a single language '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify that a new recipe is not created when the title field is empty and the Name is required message is displayed at store level with a single language '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test.skip(`Verify the creation of a new recipe with youtube video media resource at store level with a single language '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test.skip(`Verify the creation of a new recipe with vimeo video media resource at store level with a single language '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify that a new recipe is not created when the media field empty and the Media mediahref is required message is displayed at store level with a single language '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify the creation of a recipe containing instructions at store level with a single language '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if the add action of a instruction can be canceled while creating a new recipe at store level with a single language '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify that an empty instruction can not be added to a new recipe at store level with a single language '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if an instruction can be removed while creating a new recipe at store level with single language '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if an instruction can be update once is created while creating a new recipe at store level with a single language '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if is possible to add a note in a new recipe at store level with a single language '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if is possible to add an empty note in a new recipe at store level with a single language '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if is possible to cancel the add action of a note while creating a new recipe at store level with a single language '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if is possible to modify a created note while creating a new recipe at store level with a single language '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if is possible to remove a note once is created while creating a new recipe at store level with a single language '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if an ingredient is added to a new recipe at store level with a single language '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if the add ingredient action can be canceled while creating a new recipe at store level with a single language '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if an ingredient with the empty title field can not be created while creating a new recipe at store level with a single language '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if an ingredient with the description field empty can be created while creating a new recipe at store level '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if an ingredient with an invalid value on the quantity field can not be created while creating a new recipe at store level '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if an ingredient can be mapped to a card coupon type while creating a new recipe at store level '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
        ...
        expect( await recipesModel.mapToCardToogle.getAttribute('aria-checked')).toEqual('true');
    ...
    test(`Verify if an ingredient can be removed once was created while creating a new recipe at store level '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if a created recipe can be deleted at store level with a single language '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if the delete action can be canceled at store level with a single language '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if a new ingredient can be created with Coupon deal type Standard Media size and Standard card style while creating a new recipe at store level with a single language default language english '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if is possible to add a note a previously created recipe at store level with a single language '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if a new ingredient can be created with Fixed Price deal type, Standard Media size and Standard card style while creating a new recipe at store level with a single language default language english '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if a new ingredient can be created with Buy X Get Y For Z deal type, Standard Media size and Standard card style while creating a new recipe at store level with a single language default language english '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if a new ingredient can be created with # for Price deal type, Standard Media size and Standard card style while creating a new recipe at store level with a single language default language english '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if a new ingredient can be created with Amount Off Monetary deal type, Standard Media size and Standard card style while creating a new recipe at store level with a single language default language english '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if a new ingredient can be created with Amount Off Percent deal type, Standard Media size and Standard card style while creating a new recipe at store level with a single language default language english '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if is not possible create a new recipe with the expire date in the past from the start date while creating a new recipe at store level default language english '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if the expiration date can be set to today using the today button below the expires field while creating a new recipe at store level default language english '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
        ...
        await recipesModel.expiresDateSwith.click(  {delay:2000} );
        await recipesModel.todayButton.click(  {delay:2000} );
        await recipesModel.compareExpireDateToday();

    });

    test(`Verify if the expiration date can be set one week later using the next week button below the expires field while creating a new recipe at store level default language english '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if the expiration date can be reseted using the reset button below the expires field while creating a new recipe at store level default language english '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if an ingredient can be edited once is created in a new recipe at store level with a single language '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if the edition of a ingredient can be canceled while creating a new recipe at store level with a single language '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if a created ingredient can be deleted while creating a new recipe at store level with a single language '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if the name from a recipe can be edited once it has been created at store level with a single language '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if the media image from a recipe can be edited once it has been created at store level with a single language '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify that a recipe can be mapped to a store at store level with a single language '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if a new ingredient can be created with Fixed Price deal type, Full Media size and Standard card style while creating a new recipe at store level with a single language default language english '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if a new ingredient can be created with Vendor Coupon deal type, Full Media size and Standard card style while creating a new recipe at store level with a single language default language english '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if a new ingredient can be created with Amount Off Monetary deal type, Full Media size and Standard card style while creating a new recipe at store level with a single language default language english '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if a new ingredient can be created with # for Price deal type, Full Media size and Standard card style while creating a new recipe at store level with a single language default language english '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if a new ingredient can be created with Buy X Get Y For Z deal type, Full Media size and Standard card style while creating a new recipe at store level with a single language default language english '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if a new ingredient can be created with Amount Off Percent deal type, Full Media size and Standard card style while creating a new recipe at store level with a single language default language english '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`The user performs a search on the search field with valid recipe name at store level with a single language '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`The user performs a search on the search field with an invalid recipe name at store level with a single language '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if an instruction can be canceled while creating a new recipe at store level with a single language '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if the creation of a new ingredient can be canceled while creating a new recipe at store level with a single language '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if an ingredient can not be created with the title field empty in a new recipe at store level with a single language '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if an ingredient can be created with the description field empty while creating a new recipe at store level with a single language '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
        ...
        await recipesModel.addNewIngredientButton.click( {delay:1000} );
        await recipesModel.ingredientTitleField.click( {delay:1000} );
        await recipesModel.ingredientDescriptionField.click( {delay:1000} );
        await commonModel.inputTextInLocator(recipesModel.ingredientDescriptionField, "ingredient description");
        await recipesModel.ingredientQuantityField.click();
        await recipesModel.ingredientQuantityField.clear();
        await commonModel.inputTextInLocator(recipesModel.ingredientQuantityField, "1");
    ...
    test(`Verify if an ingredient can be created with an invalid value in the quantity field while creating a new recipe at store level with a single language '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if a created ingredient could be deleted while creating a new recipe at store level with a single language '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if you can cancel remove action of a created ingredient while creating a new recipe at store level with a single language '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if a new ingredient can be created with no price deal type, Standard Media size and created card style while creating a new recipe at store level with a single language default language english '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if a new ingredient can be created with Fixed Price deal type, Standard Media size and created card style while creating a new recipe at store level with a single language default language english '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if a new ingredient can be created with Buy X Get Y For Z deal type, Standard Media size and created card style while creating a new recipe at store level with a single language default language english '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if a new ingredient can be created with # for Price deal type, Standard Media size and created card style while creating a new recipe at store level with a single language default language english '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if a new ingredient can be created with Amount Off Monetary deal type, Standard Media size and created card style while creating a new recipe at store level with a single language default language english '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if a new ingredient can be created with Amount Off Percent deal type, Standard Media size and created card style while creating a new recipe at store level with a single language default language english '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if a new ingredient can be created with Coupon deal type, Standard Media size and created card style while creating a new recipe at store level with a single language default language english '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if a new ingredient can be created with No Price deal type, Full Media size and created card style while creating a new recipe at store level with a single language default language english '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if a new ingredient can be created with Fixed Price deal type, Full Media size and created card style while creating a new recipe at store level with a single language default language english '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if a new ingredient can be created with Buy X Get Y For Z deal type, Full Media size and created card style while creating a new recipe at store level with a single language default language english '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if a new ingredient can be created with # for Price deal type, Full Media size and created card style while creating a new recipe at store level with a single language default language english '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if a new ingredient can be created with Amount Off Monetary deal type, Full Media size and created card style while creating a new recipe at store level with a single language default language english '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if a new ingredient can be created with Amount Off Porcent deal type, Full Media size and created card style while creating a new recipe at store level with a single language default language english '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`The user performs a search with a valid ingredient name in the list of ingredients while creating a new recipe at store level default language english '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`The user performs a search with an invalid ingredient name in the list of ingredients while creating a new recipe at store level default language english '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if the values of a created ingredient can be update with new values at store level default language english '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
    ...
    test(`Verify if a recipe can be preview at store node level with a single language '${user.role}'`, async ({ page }) => {
        await page.goto(url);
        const loginModel = new LoginModel(page);
        const sideBarModel = new SidebarModel(page);
        const topBarModel = new TopBarModel(page);
