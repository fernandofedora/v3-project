...
users.forEach(user =>{
  ...
  test(`Create store-level static agreement type content with required fields for a single language default language English no-LPP '${user.role}'`, async ({ page }) => {
    await page.goto(url);
  ...
  test(`Create fixed price deal type content at the store level with required fields for a single language default languague english - no LPP '${user.role}'`, async ({ page }) => {
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 3600});
  ...
  test(`Create Buy X Get Y For Z deal type content at store level with required fields for a single language default languague english - no LPP '${user.role}'`, async ({ page }) => {
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 3600});
    const loginModel = new LoginModel(page);
    const sideBarModel = new SidebarModel(page);
  ...
  test(`Create # for Price deal type content at store level with required fields for a single language default languague english - no LPP '${user.role}'`, async ({ page }) => {
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 3600});
    const loginModel = new LoginModel(page);
    const sideBarModel = new SidebarModel(page);
  ...
  test(`Create Amount Off monetary deal type content at store level with required fields for a single language default languague english - no LPP '${user.role}'`, async ({ page }) => {
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 3600});
    const loginModel = new LoginModel(page);
    const sideBarModel = new SidebarModel(page);
  ...
  test(`Create Amount Off percent deal type content at store level with required fields for a single language default languague english - no LPP '${user.role}'`, async ({ page }) => {
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 3600});
    const loginModel = new LoginModel(page);
    const sideBarModel = new SidebarModel(page);
  ...
  test(`Create Vendor Coupon deal type content at store level with required fields for a single language default languague english - no LPP '${user.role}'`, async ({ page }) => {
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 3600});
    const loginModel = new LoginModel(page);
    const sideBarModel = new SidebarModel(page);
  ...
  test(`Create Share Category deal type content at store level with required fields for a single language default languague english - no LPP '${user.role}'`, async ({ page }) => {
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 3600});
    const loginModel = new LoginModel(page);
    const sideBarModel = new SidebarModel(page);
  ...
  test(`Create Recipe deal type content at store level with required fields for a single language default languague english - no LPP '${user.role}'`, async ({ page }) => {
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 3600});
    const loginModel = new LoginModel(page);
    const sideBarModel = new SidebarModel(page);
  ...
  test(`Verify you can create # / Price deal type content at store level with required fields for a single language default languague english - no LPP'${user.role}'`, async ({ page }) => {
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 3600});
    const loginModel = new LoginModel(page);
    const sideBarModel = new SidebarModel(page);
  ...
  test(`Verify that you can create a content with Save Amount monetary deal type at store level with required fields for a single language default language english - no LPP'${user.role}'`, async ({ page }) => {
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 3600});
    const loginModel = new LoginModel(page);
    const sideBarModel = new SidebarModel(page);
  ...
  test(`Verify that you can create a content with Save Amount percent deal type at store level with required fields for a single language default language english - no LPP'${user.role}'`, async ({ page }) => {
    await page.goto(url);
  ...
  test(`Verify that you can create a content with From X deal type at store level with required fields for a single language default language english - no LPP'${user.role}'`, async ({ page }) => {
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 800});
    const loginModel = new LoginModel(page);
    const sideBarModel = new SidebarModel(page);
...
users.forEach(user => {
  ...
  test(`Upload bulk content with a standard spreadsheet at store level for a single language default languague english - no LPP '${user.role}'`, async ({ page }) => {
  ...
  test(`Upload bulk content with a spreadsheet with optional fields at store level for a single language default languague english - no LPP '${user.role}'`, async ({ page }) => {
    test.setTimeout(150000);
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 3600});
    const loginModel = new LoginModel(page);
  ...
  test(`Create static deal type content at the store level with video media type and all fields for a single language default languague english - no LPP '${user.role}'`, async ({ page }) => {
    ...
    await contentModel.waitUntilContentSpinnerDisappears();
    await commonModel.setSearchValue(title);
    await contentModel.newContentIsCreated(title, dealTypes.video, brandsData.storeContent, user.role);
  ...
  test(`Create static deal type content at the store level with image media type and all fields for a single language default languague english - no LPP '${user.role}'`, async ({ page }) => {
    test.setTimeout(180000);
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 3600});
    const loginModel = new LoginModel(page);
  ...
  test(`Create fixed price deal type content at the store level with all fields for a single language default languague english - no LPP '${user.role}'`, async ({ page }) => {
    test.setTimeout(180000);
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 3600});
    const loginModel = new LoginModel(page);
  ...
  test(`Create Buy X Get Y For Z deal type content at store level with all fields for a single language default languague english - no LPP '${user.role}'`, async ({ page }) => {
    test.setTimeout(180000);
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 3600});
    const loginModel = new LoginModel(page);
  ...
  test(`Create # for Price deal type content at store level with all fields for a single language default languague english - no LPP '${user.role}'`, async ({ page }) => {
    test.setTimeout(180000);
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 3600});
    const loginModel = new LoginModel(page);
  ...
  test(`Create Amount Off monetary deal type content at store level with all fields for a single language default languague english - no LPP '${user.role}'`, async ({ page }) => {
    test.setTimeout(180000);
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 3600});
    const loginModel = new LoginModel(page);
  ...
  test(`Create Amount Off percent deal type content at store level with all fields for a single language default languague english - no LPP '${user.role}'`, async ({ page }) => {
    test.setTimeout(180000);
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 3600});
    const loginModel = new LoginModel(page);
  ...
  test(`Create No Price deal type content at store level with all fields for a single language default languague english - no LPP '${user.role}'`, async ({ page }) => {
    test.setTimeout(180000);
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 3600});
    const loginModel = new LoginModel(page);
    ...
    await contentModel.waitUntilContentSpinnerDisappears();
    await commonModel.setSearchValue(title);
    await contentModel.newContentIsCreated(title, dealTypes.noPrice, brandsData.storeContent, user.role);
  ...
  test(`Create Vendor Coupon deal type content at store level with all fields for a single language default languague english - no LPP '${user.role}'`, async ({ page }) => {
    test.setTimeout(180000);
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 3600});
    const loginModel = new LoginModel(page);
  ...
  test(`Create Share Category deal type content at store level with all fields for a single language default languague english - no LPP '${user.role}'`, async ({ page }) => {
    test.setTimeout(180000);
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 3600});
    const loginModel = new LoginModel(page);
  ...
  test(`Create Recipe deal type content at store level with all fields for a single language default languague english - no LPP '${user.role}'`, async ({ page }) => {
    test.setTimeout(180000);
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 3600});
    const loginModel = new LoginModel(page);
  ...
  test(`Create # / Price deal type card at store level with all fields for a single language default language English - no LPP'${user.role}'`, async ({ page }) => {
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 800});
    const loginModel = new LoginModel(page);
    const sideBarModel = new SidebarModel(page);
  ...
  test(`Create Save Amount monetary deal type card at store level with all fields for a single language default language English - no LPP'${user.role}'`, async ({ page }) => {
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 800});
    const loginModel = new LoginModel(page);
    const sideBarModel = new SidebarModel(page);
  ...
  test(`Create Save Amount percent deal type card at store level with all fields for a single language default language English - no LPP'${user.role}'`, async ({ page }) => {
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 800});
    const loginModel = new LoginModel(page);
    const sideBarModel = new SidebarModel(page);
  ...
  test(`Create From X deal type card at store level with all fields for a single language default language English - no LPP'${user.role}'`, async ({ page }) => {
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 800});
    const loginModel = new LoginModel(page);
    const sideBarModel = new SidebarModel(page);
...
users.forEach(user =>{
  ...
  test.skip(`Verify that it is possible to create manual Static content No Price from the content bulk upload / Store Level CDL off '${user.role}'`, async ({ page }) => {
    await page.goto(url);
  ...
  test.skip(`Verify that it is possible to create manual Fixed Price content from the content bulk upload / Store Level CDL off '${user.role}'`, async ({ page }) => {
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 2000});
    const loginModel = new LoginModel(page);
    const sideBarModel = new SidebarModel(page);
  ...
  test.skip(`Verify that it is possible to create manual Buy X Get Y For Z content from the content bulk upload / Store Level CDL off '${user.role}'`, async ({ page }) => {
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 2000});
    const loginModel = new LoginModel(page);
    const sideBarModel = new SidebarModel(page);
  ...
  test.skip(`Verify that it is possible to create manual Vendor coupon content from the content bulk upload / Store Level CDL off '${user.role}'`, async ({ page }) => {
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 2000});
    const loginModel = new LoginModel(page);
    const sideBarModel = new SidebarModel(page);
  ...
  test(`Verify that it is not possible to upload content without a title in the content bulk upload store level '${user.role}'`, async ({ page }) => {
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 2000});
    const loginModel = new LoginModel(page);
    const sideBarModel = new SidebarModel(page);
  ...
  test(`Verify that it is possible to create a content after obtaining the required title validation in the content bulk upload store level '${user.role}'`, async ({ page }) => {
    await page.goto(url);
  ...
  test(`Verify that it is possible to create icons for content store '${user.role}'`, async ({ page }) => {
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 2000});
    const loginModel = new LoginModel(page);
    const sideBarModel = new SidebarModel(page);
  ...
  test(`Verify that it is possible to create a Headline for content store '${user.role}'`, async ({ page }) => {
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 2000});
    const loginModel = new LoginModel(page);
    const sideBarModel = new SidebarModel(page);
  ...
  test(`Verify that it is not possible to save a headline with empty fields store level '${user.role}'`, async ({ page }) => {
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 2000});
    const loginModel = new LoginModel(page);
    const sideBarModel = new SidebarModel(page);
  ...
  test(`Verify the validation of the required field in the form to add new icons to the content store '${user.role}'`, async ({ page }) => {
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 2000});
    const loginModel = new LoginModel(page);
    const sideBarModel = new SidebarModel(page);
...
test(`Verify that the fields to add coupons to the content are visible when the node has the option Coupon support / deal type fixed price - store level active`, async ({ page }) => {
  await page.goto(url);
  await page.setViewportSize({width: 1600, height: 2000});
  const loginModel = new LoginModel(page);
  const sideBarModel = new SidebarModel(page);
...
test(`Verify that it is possible to create deal type fixed content with coupons fields store - level`, async ({ page }) => {
  await page.goto(url);
  await page.setViewportSize({width: 1600, height: 2000});
  const loginModel = new LoginModel(page);
  const sideBarModel = new SidebarModel(page);
  ...
  await contentModel.waitUntilContentSpinnerDisappears();
  await commonModel.setSearchValue(title);
  await contentModel.newContentIsCreated(title, dealTypes.fixedPrice, brandsData.storeContent);
...
test(`Verify that it is possible to create deal type #for price content with coupons fields store - level`, async ({ page }) => {
  await page.goto(url);
  await page.setViewportSize({width: 1600, height: 2000});
  const loginModel = new LoginModel(page);
  const sideBarModel = new SidebarModel(page);
  ...
  await contentModel.waitUntilContentSpinnerDisappears();
  await commonModel.setSearchValue(title);
  await contentModel.newContentIsCreated(title, dealTypes.numberForPrice, brandsData.storeContent);
...
test(`Verify that the fields to add coupons to the content are visible when the node has the option Coupon support / deal type for price-store level active`, async ({ page }) => {
  await page.goto(url);
  await page.setViewportSize({width: 1600, height: 2000});
  const loginModel = new LoginModel(page);
  const sideBarModel = new SidebarModel(page);
...
test.skip(`Verify that it is possible to add categories from the categories form in the content module store Level`, async ({ page }) => {
  await page.goto(url);
  await page.setViewportSize({width: 1600, height: 2000});
  const loginModel = new LoginModel(page);
  const sideBarModel = new SidebarModel(page);
