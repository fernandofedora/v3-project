...
users.forEach(user =>{
  ...
  test(`Create subbrand-level static agreement type content with required fields for a single language default language English no-LPP '${user.role}'`, async ({ page }) => {
    await page.goto(url);
  ...
  test(`Create fixed price deal type content at the subbrand level with required fields for a single language default languague english - no LPP '${user.role}'`, async ({ page }) => {
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 3600});
  ...
  test(`Create Buy X Get Y For Z deal type content at subbrand level with required fields for a single language default languague english - no LPP '${user.role}'`, async ({ page }) => {
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 3600});
    const loginModel = new LoginModel(page);
    const sideBarModel = new SidebarModel(page);
  ...
  test(`Create # for Price deal type content at subbrand level with required fields for a single language default languague english - no LPP '${user.role}'`, async ({ page }) => {
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 3600});
    const loginModel = new LoginModel(page);
    const sideBarModel = new SidebarModel(page);
  ...
  test(`Create Amount Off monetary deal type content at subbrand level with required fields for a single language default languague english - no LPP '${user.role}'`, async ({ page }) => {
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 3600});
    const loginModel = new LoginModel(page);
    const sideBarModel = new SidebarModel(page);
  ...
  test(`Create Amount Off percent deal type content at subbrand level with required fields for a single language default languague english - no LPP '${user.role}'`, async ({ page }) => {
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 3600});
    const loginModel = new LoginModel(page);
    const sideBarModel = new SidebarModel(page);
  ...
  test(`Create Recipe deal type content at subbrand level with required fields for a single language default languague english - no LPP '${user.role}'`, async ({ page }) => {
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 3600});
    const loginModel = new LoginModel(page);
    const sideBarModel = new SidebarModel(page);
  ...
  test(`Verify that you can create a content with From X deal type at subbrand level with required fields for a single language default language english - no LPP'${user.role}'`, async ({ page }) => {
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 800});
    const loginModel = new LoginModel(page);
    const sideBarModel = new SidebarModel(page);
...
users.forEach(user => {
  ...
  test(`Create static deal type content at the subbrand level with video media type and all fields for a single language default languague english - no LPP '${user.role}'`, async ({ page }) => {
    ...
    await contentModel.waitUntilContentSpinnerDisappears();
    await commonModel.setSearchValue(title);
    await contentModel.newContentIsCreated(title, dealTypes.video, brandsData.subBrandContent, user.role);
  ...
  test(`Create static deal type content at the subbrand level with image media type and all fields for a single language default languague english - no LPP '${user.role}'`, async ({ page }) => {
    test.setTimeout(180000);
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 3600});
    const loginModel = new LoginModel(page);
    ...
    await contentModel.cardDetailLabel.click();
    //await contentModel.singleItemButton.click();
    await contentModel.waitUntilContentSpinnerDisappears();0
    await commonModel.setSearchValue(title);
    await contentModel.newContentIsCreated(title, dealTypes.static, brandsData.subBrandContent, user.role);
  ...
  test(`Create fixed price deal type content at the subbrand level with all fields for a single language default languague english - no LPP '${user.role}'`, async ({ page }) => {
    test.setTimeout(180000);
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 3600});
    const loginModel = new LoginModel(page);
  ...
  test(`Create Buy X Get Y For Z deal type content at subbrand level with all fields for a single language default languague english - no LPP '${user.role}'`, async ({ page }) => {
    test.setTimeout(180000);
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 3600});
    const loginModel = new LoginModel(page);
  ...
  test(`Create # for Price deal type content at subbrand level with all fields for a single language default languague english - no LPP '${user.role}'`, async ({ page }) => {
    test.setTimeout(180000);
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 3600});
    const loginModel = new LoginModel(page);
  ...
  test(`Create Amount Off monetary deal type content at subbrand level with all fields for a single language default languague english - no LPP '${user.role}'`, async ({ page }) => {
    test.setTimeout(180000);
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 3600});
    const loginModel = new LoginModel(page);
  ...
  test(`Create Amount Off percent deal type content at subbrand level with all fields for a single language default languague english - no LPP '${user.role}'`, async ({ page }) => {
    test.setTimeout(180000);
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 3600});
    const loginModel = new LoginModel(page);
  ...
  test(`Create No Price deal type content at subbrand level with all fields for a single language default languague english - no LPP '${user.role}'`, async ({ page }) => {
    test.setTimeout(180000);
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 3600});
    const loginModel = new LoginModel(page);
    ...
    await contentModel.waitUntilContentSpinnerDisappears();
    await commonModel.setSearchValue(title);
    await contentModel.newContentIsCreated(title, dealTypes.noPrice, brandsData.subBrandContent, user.role);
  ...
  test(`Create Vendor Coupon deal type content at subbrand level with all fields for a single language default languague english - no LPP '${user.role}'`, async ({ page }) => {
    test.setTimeout(180000);
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 3600});
    const loginModel = new LoginModel(page);
  ...
  test(`Create Share Category deal type content at subbrand level with all fields for a single language default languague english - no LPP '${user.role}'`, async ({ page }) => {
    test.setTimeout(180000);
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 3600});
    const loginModel = new LoginModel(page);
  ...
  test(`Create Recipe deal type content at subbrand level with all fields for a single language default languague english - no LPP '${user.role}'`, async ({ page }) => {
    test.setTimeout(180000);
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 3600});
    const loginModel = new LoginModel(page);
  ...
  test(`Create # / Price deal type card at subbrand level with all fields for a single language default language English - no LPP'${user.role}'`, async ({ page }) => {
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 800});
    const loginModel = new LoginModel(page);
    const sideBarModel = new SidebarModel(page);
  ...
  test(`Create Save Amount monetary deal type card at subbrand level with all fields for a single language default language English - no LPP'${user.role}'`, async ({ page }) => {
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 800});
    const loginModel = new LoginModel(page);
    const sideBarModel = new SidebarModel(page);
  ...
  test(`Create Save Amount percent deal type card at subbrand level with all fields for a single language default language English - no LPP'${user.role}'`, async ({ page }) => {
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 800});
    const loginModel = new LoginModel(page);
    const sideBarModel = new SidebarModel(page);
  ...
  test(`Create From X deal type card at subbrand level with all fields for a single language default language English - no LPP'${user.role}'`, async ({ page }) => {
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 800});
    const loginModel = new LoginModel(page);
    const sideBarModel = new SidebarModel(page);
...
test(`Verify that the circular start dates match the edited nodes circulars start day of week and time of day and timezone at subbrand level`, async ({ page }) => {
  await page.goto(url);
...
users.forEach(user =>{
  ...
  test(`Verify that it is possible to create a content after obtaining the required title validation in the content bulk upload subbrand '${user.role}'`, async ({ page }) => {
    await page.goto(url);
  ...
  test(`Verify that it is possible to create icons for content subbrand '${user.role}'`, async ({ page }) => {
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 2000});
    const loginModel = new LoginModel(page);
    const sideBarModel = new SidebarModel(page);
  ...
  test(`Verify that it is possible to create a Headline for content subbrand '${user.role}'`, async ({ page }) => {
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 2000});
    const loginModel = new LoginModel(page);
    const sideBarModel = new SidebarModel(page);
  ...
  test(`Verify that it is not possible to save a headline with empty fields subbrand level '${user.role}'`, async ({ page }) => {
    await page.goto(url);
    await page.setViewportSize({width: 1600, height: 2000});
    const loginModel = new LoginModel(page);
    const sideBarModel = new SidebarModel(page);
...
test(`Verify that the fields to add coupons to the content are visible when the node has the option Coupon support / deal type fixed price - subbrands level active`, async ({ page }) => {
  await page.goto(url);
  await page.setViewportSize({width: 1600, height: 2000});
  const loginModel = new LoginModel(page);
  const sideBarModel = new SidebarModel(page);
...
test(`Verify that it is possible to create deal type fixed content with coupons fields subbrand - level`, async ({ page }) => {
  await page.goto(url);
  await page.setViewportSize({width: 1600, height: 2000});
  const loginModel = new LoginModel(page);
  const sideBarModel = new SidebarModel(page);
  ...
  await contentModel.waitUntilContentSpinnerDisappears();
  await commonModel.setSearchValue(title);
  await contentModel.newContentIsCreated(title, dealTypes.fixedPrice, brandsData.subBrandContent);
...
test(`Verify that it is possible to create deal type #for price content with coupons fields subbrand - level`, async ({ page }) => {
  await page.goto(url);
  await page.setViewportSize({width: 1600, height: 2000});
  const loginModel = new LoginModel(page);
  const sideBarModel = new SidebarModel(page);
  ...
  await contentModel.waitUntilContentSpinnerDisappears();
  await commonModel.setSearchValue(title);
  await contentModel.newContentIsCreated(title, dealTypes.numberForPrice, brandsData.subBrandContent);
